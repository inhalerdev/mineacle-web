...
function mineacle_page_head(string $title): void {
    ...
    echo '<link rel="icon" type="image/png" href="assets/mineacle-square-logo.png?v=bansfull3.8.7.7.6.5.4.3.2">';
    echo '<link rel="stylesheet" href="assets/styles.css?v=bansfull3.8.7.7.6.5.4.3.2">';
    echo '</head>';
}
...
function mineacle_header(string $active = 'bans'): void {
    ...
    echo '</nav>';
    echo '<a class="header-bans-logo" href="" aria-label="Refresh Mineacle Bans"><img src="assets/mineacle-bans-hero-logo.png?v=bansfull3.8.7.7.6.5.4.3.2" alt="Mineacle Bans"></a>';
    echo '<nav class="blocaria-nav-right" aria-label="Actions">';
    echo '<a class="discord-square nav-mc-icon-button header-discord-button" href="' . $discord . '" target="_blank" rel="noopener" aria-label="Join Discord"><img src="assets/discord.svg?v=bansfull3.8.7.7.6.5.4.3.2" alt=""></a>';
    ...
    echo '<a class="' . ($active === 'vote' ? 'active' : '') . '" href="' . $vote . '"><img class="nav-icon icon-white" src="assets/vote.svg?v=bansfull3.8.7.7.6.5.4.3.2" alt=""><span>Vote</span></a>';
    echo '<a class="' . ($active === 'bans' ? 'active' : '') . '" href="' . $bans . '"><img class="nav-icon icon-white" src="assets/hammer.svg?v=bansfull3.8.7.7.6.5.4.3.2" alt=""><span>Bans</span></a>';
    echo '<a class="store-link ' . ($active === 'store' ? 'active' : '') . '" href="' . $store . '"><img class="nav-icon icon-white" src="assets/store.svg?v=bansfull3.8.7.7.6.5.4.3.2" alt=""><span>Store</span></a>';
    echo '</nav>';
    echo '</div></header>';
}
...
function mineacle_footer(): void {
    ...
    echo '<div class="footer-brand"><img class="footer-brand-logo" src="assets/mineacle-main-logo.png?v=bansfull3.8.7.7.6.5.4.3.2" alt="Mineacle Network"></div>';
    ...
    echo '<a class="footer-social-link" href="' . $discord . '" target="_blank" rel="noopener" aria-label="Join Mineacle Discord"><img src="assets/discord.svg?v=bansfull3.8.7.7.6.5.4.3.2" alt=""></a>';
    echo '<a class="footer-social-link" href="' . $x . '" target="_blank" rel="noopener" aria-label="Follow Mineacle on X"><img src="assets/x.svg?v=bansfull3.8.7.7.6.5.4.3.2" alt=""></a>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
    echo '</footer>';
    ...
    echo '<script src="assets/main.js?v=bansfull3.8.7.7.6.5.4.3.2"></script>';
}
