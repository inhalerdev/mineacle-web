...
function mineacle_page_head(string $title): void {
    ...
    $version = 'bansfull3.8.67-header-modal-hardfix';
...
function mineacle_header(string $active = 'bans'): void {
    ...
    echo '<header class="site-header blocaria-style-header mineacle-floating-header mcx-header mcx-clean-header-v67" id="siteHeader">';
    ...
    echo '<img src="assets/mineacle-bans-hero-logo.png?v=bansfull3.8.67-header-modal-hardfix" alt="Mineacle Bans">';
    echo '</a>';

    echo '<a class="mcx-discord" href="' . $discord . '" target="_blank" rel="noopener" aria-label="Join Discord">';
    echo '<img src="assets/discord.svg?v=bansfull3.8.67-header-modal-hardfix" alt="">';
    echo '</a>';
    ...
    echo '<a class="mcx-mobile-item mcx-mobile-discord" href="' . $discord . '" target="_blank" rel="noopener"><img src="assets/discord.svg?v=bansfull3.8.67-header-modal-hardfix" alt=""><span>Discord</span></a>';
    echo '</div>';
    echo '</nav>';
