...
function mineacle_page_head(string $title, string $description = 'Search active bans on Mineacle Network'): void {
    ...
    echo '<link rel="icon" type="image/svg+xml" href="assets/icons/mineacle-m.svg?v=6.2.0">';
    echo '<link rel="preconnect" href="https://mc-heads.net">';
    echo '<link rel="stylesheet" href="assets/styles.css?v=6.2.0">';
    echo '</head><body>';
}

function mineacle_page_end(): void {
    echo '<script src="assets/app.js?v=6.2.0" defer></script>';
    echo '</body></html>';
}
