...
function mineacle_page_head(string $title): void {
    ...
    echo '<link rel="icon" type="image/png" href="assets/mineacle-square-logo.png?v=bansfull3.8.24.244.233.222.211.200.199.188.177.166.144.8.7.6.5.4.3.2">';
    echo '<link rel="stylesheet" href="assets/styles.css?v=bansfull3.8.24.244.233.222.211.200.199.188.177.166.144.8.7.6.5.4.3.2">';
    echo '</head>';
}
...
function mineacle_header(string $active = 'bans'): void {
    ...
    echo '<img src="assets/mineacle-bans-hero-logo.png?v=bansfull3.8.24.244.233.222.211.200.199" alt="Mineacle Bans">';
    echo '</a>';

    echo '<a class="mcx-discord" href="' . $discord . '" target="_blank" rel="noopener" aria-label="Join Discord">';
    echo '<img src="assets/discord.svg?v=bansfull3.8.24.244.233.222.211.200.199" alt="">';
    echo '</a>';
    ...
    echo '<a class="mcx-mobile-discord" href="' . $discord . '" target="_blank" rel="noopener"><img src="assets/discord.svg?v=bansfull3.8.24.244.233.222" alt=""><span>Discord</span></a>';
    echo '</nav>';
...
function mineacle_footer(): void {
    ...
    echo '<div class="footer-brand"><img class="footer-brand-logo" src="assets/mineacle-main-logo.png?v=bansfull3.8.24.244.233.222.211.200.199.188.177.166.144.8.7.6.5.4.3.2" alt="Mineacle Network"></div>';
    ...
    echo '<a class="footer-social-link" href="' . $discord . '" target="_blank" rel="noopener" aria-label="Join Mineacle Discord"><img src="assets/discord.svg?v=bansfull3.8.24.244.233.222.211.200.199.188.177.166.144.8.7.6.5.4.3.2" alt=""></a>';
    echo '<a class="footer-social-link" href="' . $x . '" target="_blank" rel="noopener" aria-label="Follow Mineacle on X"><img src="assets/x.svg?v=bansfull3.8.24.244.233.222.211.200.199.188.177.166.144.8.7.6.5.4.3.2" alt=""></a>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
    echo '</footer>';
    ...
    echo '<script src="assets/main.js?v=bansfull3.8.24.244.233.222.211.200.199.188.177.166.144.8.7.6.5.4.3.2"></script>';
}
