...
function mineacle_page_head(string $title): void {
    ...
    echo '<link rel="icon" type="image/png" href="assets/mineacle-square-logo.png?v=foundation1.45">';
    echo '<link rel="stylesheet" href="assets/styles.css?v=foundation1.45">';
    echo '</head>';
}
...
function mineacle_header(string $active = 'bans'): void {
    ...
    echo '<a class="header-logo-link" href="' . $home . '" aria-label="Go to Mineacle home"><img src="assets/mineacle-square-logo.png?v=foundation1.45" alt="Mineacle"></a>';
    echo '<nav class="main-nav" aria-label="Primary navigation">';
    echo '<a class="' . ($active === 'home' ? 'active' : '') . '" href="' . $home . '"><img class="nav-icon icon-white" src="assets/home.svg?v=foundation1.45" alt=""><span>Home</span></a>';
    echo '<a class="' . ($active === 'vote' ? 'active' : '') . '" href="' . $vote . '"><img class="nav-icon icon-white" src="assets/vote.svg?v=foundation1.45" alt=""><span>Vote</span></a>';
    echo '<a class="' . ($active === 'bans' ? 'active' : '') . '" href="/"><img class="nav-icon icon-white" src="assets/hammer.svg?v=foundation1.45" alt=""><span>Bans</span></a>';
    echo '<a class="store-link ' . ($active === 'store' ? 'active' : '') . '" href="' . $store . '"><img class="nav-icon icon-white" src="assets/store.svg?v=foundation1.45" alt=""><span>Store</span></a>';
    echo '</nav>';
...
function mineacle_footer(): void {
    ...
    echo '<img class="footer-only-logo" src="assets/mineacle-main-logo.png?v=foundation1.45" alt="Mineacle">';
    echo '</footer>';
    ...
    echo '</div>';
    echo '<script src="assets/main.js?v=foundation1.45"></script>';
}
