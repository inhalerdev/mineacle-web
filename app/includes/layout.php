...
function mineacle_page_head(string $title): void {
    ...
    $version = 'bansfull3.8.45-intellij-font-family-fix';
...
function mineacle_header(string $active = 'bans'): void {
    ...
    echo '<img src="assets/mineacle-bans-hero-logo.png?v=bansfull3.8.45-intellij-font-family-fix" alt="Mineacle Bans">';
    echo '</a>';

    echo '<a class="mcx-discord" href="' . $discord . '" target="_blank" rel="noopener" aria-label="Join Discord">';
    echo '<img src="assets/discord.svg?v=bansfull3.8.45-intellij-font-family-fix" alt="">';
    echo '</a>';
    ...
    echo '<a class="mcx-mobile-item mcx-mobile-discord" href="' . $discord . '" target="_blank" rel="noopener"><img src="assets/discord.svg?v=bansfull3.8.45-intellij-font-family-fix" alt=""><span>Discord</span></a>';
    echo '</div>';
    echo '</nav>';
