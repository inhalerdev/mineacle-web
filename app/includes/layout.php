...
function mineacle_page_head(string $title): void {
    ...
    echo '<link rel="stylesheet" href="assets/styles.css?v=banssingle4.0.08">';
    echo '</head>';
}
...
function mineacle_header(string $active = 'bans'): void {
    ...
    echo '<img class="mcx-players-icon" src="assets/players-online-icon.png?v=banssingle4.0.08" alt="">';
...
function mineacle_footer(): void {
    ...
    echo '</div>';
    echo '</footer>';
    echo '<script src="assets/main.js?v=banssingle4.0.08"></script>';
    echo '<script src="assets/hero-scroll.js?v=banssingle4.0.08"></script>';
    echo '<script src="assets/nav-server-status.js?v=banssingle4.0.08"></script>';
...
(function(){
  function applyClientGuardRefresh(){
    ...
    if (img) {
      img.src = 'assets/mineacle-clientguard-logo-v2.png?v=banssingle4.0.08';
