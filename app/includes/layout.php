...
function mineacle_page_head(string $title = 'Home'): void
{
    ...
    echo '<link rel="icon" type="image/png" href="/assets/fav.png?v=base46">';
    echo '<link rel="stylesheet" href="/assets/home-page.css?v=base46">';
    echo '</head>';
    echo '<body>';
}
...
{
    echo '<script src="/assets/home-page.js?v=base46"></script>';
    echo '</body>';
    echo '</html>';
}
