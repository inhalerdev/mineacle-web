...
function mineacle_page_head(string $title): void {
    ...
    echo '<link rel="icon" type="image/png" href="assets/mineacle-square-logo.png?v=bansfull1.4.1">';
    echo '<link rel="stylesheet" href="assets/styles.css?v=bansfull1.4.1">';
    echo '</head>';
}
...
function mineacle_header(string $active = 'bans'): void {
    ...
    echo '<div class="header-logo-link header-logo-static" aria-label="Mineacle bans"><img src="assets/mineacle-square-logo.png?v=bansfull1.4.1" alt="Mineacle"></div>';
    ...
    echo '<a class="' . ($active === 'vote' ? 'active' : '') . '" href="' . $vote . '"><img class="nav-icon icon-white" src="assets/vote.svg?v=bansfull1.4.1" alt=""><span>Vote</span></a>';
    echo '<a class="' . ($active === 'bans' ? 'active' : '') . '" href="' . $bans . '"><img class="nav-icon icon-white" src="assets/hammer.svg?v=bansfull1.4.1" alt=""><span>Bans</span></a>';
    echo '<a class="store-link ' . ($active === 'store' ? 'active' : '') . '" href="' . $store . '"><img class="nav-icon icon-white" src="assets/store.svg?v=bansfull1.4.1" alt=""><span>Store</span></a>';
    echo '</nav>';
...
function mineacle_footer(): void {
    ...
    echo '<div class="footer-brand"><img class="footer-brand-logo" src="assets/mineacle-main-logo.png?v=bansfull1.4.1" alt="Mineacle Network"></div>';
    ...
    echo '<a class="footer-social-link" href="' . $discord . '" target="_blank" rel="noopener" aria-label="Join Mineacle Discord"><img src="assets/discord.svg?v=bansfull1.4.1" alt=""></a>';
    echo '<a class="footer-social-link" href="' . $x . '" target="_blank" rel="noopener" aria-label="Follow Mineacle on X"><img src="assets/x.svg?v=bansfull1.4.1" alt=""></a>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
    echo '</footer>';
    ...
    echo '<script src="assets/main.js?v=bansfull1.4.1"></script>';
}
