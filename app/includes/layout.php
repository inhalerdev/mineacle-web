...
function mineacle_page_head(string $title): void {
    ...
    echo '<link rel="icon" type="image/png" href="assets/mineacle-logo-purple.png?v=bansclean1.0.5">';
    mineacle_critical_styles();
    echo '<link rel="stylesheet" href="assets/bans-page.css?v=bansclean1.0.5">';
    echo '</head>';
    echo '<body>';
}
...
function mineacle_footer(): void {
    ...
    echo '<img src="assets/mineacle-logo-purple.png?v=bansclean1.0.5" alt="Mineacle">';
    echo '<h2>Mineacle</h2>';
    echo '<p>Search active banned players from the public bans database.</p>';
    echo '<div class="mineacle-footer-socials">';
    echo '<a href="' . $discord . '" target="_blank" rel="noopener" aria-label="Discord"><img src="assets/discord.svg?v=bansclean1.0.5" alt=""></a>';
    echo '<a href="' . $x . '" target="_blank" rel="noopener" aria-label="X"><img src="assets/x.svg?v=bansclean1.0.5" alt=""></a>';
    echo '</div>';
    echo '</section>';
    ...
    echo '<span><img src="assets/mineacle-logo-purple.png?v=bansclean1.0.5" alt=""> Copyright © 2026 Mineacle Network. All Rights Reserved.</span>';
    echo '<span>Not affiliated with Microsoft or Mojang AB.</span>';
    echo '</div>';
    echo '</footer>';
    echo '<script src="assets/bans-page.js?v=bansclean1.0.5"></script>';
    echo '</body></html>';
}
