...
function mineacle_page_head(string $title): void {
    ...
    echo '<link rel="stylesheet" href="assets/bans-page.css?v=bansclean1.0.8">';
    echo '</head>';
    echo '<body>';
}
...
.mineacle-footer-brand-logo{width:clamp(170px,15vw,240px);max-width:100%;display:inline-block;margin-bottom:18px}.mineacle-footer-brand-logo img{width:100%;height:auto;max-height:136px;display:block;object-fit:contain;filter:grayscale(1) brightness(1.16) contrast(1.05);opacity:.72;transition:filter .26s ease,opacity .26s ease,transform .26s ease}.mineacle-footer-brand-logo:hover img,.mineacle-footer-brand-logo:focus-visible img{filter:grayscale(0) brightness(1) contrast(1);opacity:1;transform:translateY(-1px)}.mineacle-footer-brand h2{margin:0 0 14px;color:#fff;font-size:31px;line-height:1.05;font-weight:950}.mineacle-footer-brand p{width:min(100%,360px);margin:0;color:var(--muted);font-size:16px;line-height:1.55;font-weight:780}
