...
<main class="app-shell" data-app data-server-ip="<?php echo $ip; ?>">
    <aside class="rail" aria-label="Mineacle navigation">
        <a class="rail-logo" href="<?php echo $bans; ?>" aria-label="Mineacle Bans">
            <img src="assets/brand/mineacle-m.webp?v=6.7.0" alt="Mineacle">
        </a>

        <nav class="rail-nav" aria-label="Primary links">
            <a class="rail-link active" href="<?php echo $bans; ?>" aria-label="Bans" title="Bans"><img src="assets/icons/hammer.svg?v=6.7.0" alt=""></a>
            <a class="rail-link" href="<?php echo $stats; ?>" aria-label="Stats" title="Stats"><img src="assets/icons/users.svg?v=6.7.0" alt=""></a>
            <a class="rail-link" href="<?php echo $vote; ?>" aria-label="Vote" title="Vote"><img src="assets/icons/star.svg?v=6.7.0" alt=""></a>
            <a class="rail-link" href="<?php echo $store; ?>" aria-label="Store" title="Store"><img src="assets/icons/store.svg?v=6.7.0" alt=""></a>
        </nav>

        <a class="rail-link rail-discord" href="<?php echo $discord; ?>" target="_blank" rel="noopener" aria-label="Discord" title="Discord">
            <img src="assets/icons/discord.svg?v=6.7.0" alt="">
        </a>
    </aside>
    ...
    <section class="content-lane">
        <header class="topbar" aria-label="Search Mineacle records">
            <form class="search-module module" id="banSearchForm" role="search">
                ...
                <button class="search-button" id="banSearchAction" type="submit" aria-label="Search and open player profile"><img src="assets/icons/search.svg?v=6.7.0" alt=""></button>
            </form>
        </header>
        ...
        <section class="top-stage" aria-label="Mineacle overview">
            <section class="hero-module module" aria-labelledby="heroTitle">
                <div class="hero-media" aria-hidden="true">
                    <img src="assets/brand/hero-world.webp?v=6.7.0" alt="" loading="eager">
                </div>
                <div class="hero-copy">
                    <img class="hero-brand-logo" src="assets/brand/mineacle-logo-full.webp?v=6.7.0" alt="Mineacle">
                ...
                <div class="hero-mark" aria-hidden="true">
                    <img src="assets/brand/mineacle-m.webp?v=6.7.0" alt="">
                </div>
            </section>
        ...
        <footer class="footer-module module" aria-label="Mineacle footer">
            <section class="footer-brand">
                <img class="footer-logo" src="assets/brand/mineacle-studios.webp?v=6.7.0" alt="Mineacle Studios">
                <h2>Mineacle</h2>
                <p>Transparent active ban records for a protected Minecraft survival community</p>
                <div class="footer-socials">
                    <a href="<?php echo $discord; ?>" target="_blank" rel="noopener" aria-label="Discord"><img src="assets/icons/discord.svg?v=6.7.0" alt=""></a>
                    <a href="<?php echo $x; ?>" target="_blank" rel="noopener" aria-label="X"><img src="assets/icons/x.svg?v=6.7.0" alt=""></a>
                </div>
            </section>
