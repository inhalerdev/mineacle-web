  ...
  <section class="hero-shell" aria-label="Mineacle public bans hero">
    <div class="hero-grid">
      <div class="hero-main-logo-wrap" aria-label="Mineacle main logo">
        <img class="hero-main-logo" src="assets/mineacle-bans-logo.png?v=bansfull1.3.1" alt="Mineacle Bans">
      </div>
      ...
      <div class="hero-copy">
        ...
        <a class="discord-panel" href="<?= h($config['site']['discord']) ?>" target="_blank" rel="noopener">
          <div class="discord-character-wrap">
            <img class="discord-character" src="assets/discord-character.webp?v=bansfull1.3.1" alt="">
          </div>
          <div>
  ...
  <section class="bans-section" id="bans">
    ...
    <div class="ban-list-wrap">
      <div class="ban-toolbar">
        ...
        <div class="searchbar">
          <img class="search-icon" src="assets/search-icon.png?v=bansfull1.3.1" alt="" aria-hidden="true">
